...
Original file is located at
    https://colab.research.google.com/drive/1zefFjnJ8RycrISd4g5bDQu7oabQytueM
"""
...
class SiameseDataset(Dataset):
    def __init__(self, tokenizer, df, max_len=2048):
        ...
        self.class_column = [(lambda x:  df.iloc[x]["label_index"] + '</s>')
                             (x) for x in range(len(df))]
...
trainer.hyperparameter_search(direction="maximize", hp_space=hyperparameter_space, n_trials = 50)
# trainer.train()
# trainer.save_model()