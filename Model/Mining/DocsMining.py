...
if __name__ == '__main__':
    ...
    for root, dirs, files in os.walk(path_common.data.value + "\\Docs", topdown=True):
        for file in tqdm(files):
            ...
            with open(file=path, mode='r', encoding='utf-8') as f:
                ...
                for h in head:
                    ...
                    intent = h2.text
                    intent_new = {'intent_index': intent_index, 'intent': intent, "intent_group": intent_group, "intent_group_index": intent_group_index}
                    ...
                    for e in elements:
                        ...
                        if not value == "":
                            ...
                            sentence_new = {'sentence_index': sentence_index, 'intent': intent, 'sentence': sentence,
                                            'intent_index': intent_index, "intent_group": intent_group, "intent_group_index": intent_group_index}
